<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="统计备注" prop="tongjibeizhu">
          <el-input v-model="ruleForm.tongjibeizhu" 
              placeholder="统计备注" clearable  :readonly="ro.tongjibeizhu"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="统计备注" prop="tongjibeizhu">
              <el-input v-model="ruleForm.tongjibeizhu" 
                placeholder="统计备注" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.chengji = true;
          ...
          if(o=='tongjibeizhu'){
            this.ruleForm.tongjibeizhu = obj[o];
	    this.ro.tongjibeizhu = true;
            continue;
          }
          if(o=='tongjiriqi'){
		 ...
		 if(crossrefid && crossuserid) {
			...
			this.$http({ 
				...
				if (data && data.code === 0) { 
					 ...
					 this.$http({
					   url: `chengjitongji/${!this.ruleForm.id ? "save" : "update"}`,
					   method: "post",
					   data: this.ruleForm
					 }).then(({ data }) => {
					   if (data && data.code === 0) {
						 ...
						 this.parent.chengjitongjiCrossAddOrUpdateFlag = false;
						 this.parent.search();
