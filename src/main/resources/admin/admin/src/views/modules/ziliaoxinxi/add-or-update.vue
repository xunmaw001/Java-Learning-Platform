<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="24">  
        <el-form-item class="upload" v-if="type!='info' && !ro.ziliaofengmian" label="资料封面" prop="ziliaofengmian">
          <file-upload
          tip="点击上传资料封面"
          action="file/upload"
          :limit="3"
        ...
        <div v-else>
          <el-form-item v-if="ruleForm.ziliaofengmian" label="资料封面" prop="ziliaofengmian">
            <img style="margin-right:20px;" v-bind:key="index" v-for="(item,index) in ruleForm.ziliaofengmian.split(',')" :src="$base.url+item" width="100" height="100">
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
      ...
      <el-col :span="24">  
        ...
        <div v-else>
          <el-form-item v-if="ruleForm.ziliaowenjian" label="资料文件" prop="ziliaowenjian">
            <el-button type="text" size="small" @click="download($base.url+ruleForm.ziliaowenjian)">下载</el-button>
          </el-form-item>
        </div>    
      </el-col>      
      <el-col :span="12">
