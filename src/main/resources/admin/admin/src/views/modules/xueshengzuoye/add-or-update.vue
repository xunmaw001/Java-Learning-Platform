<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="24">  
        <el-form-item class="upload" v-if="type!='info'&& !ro.xueshengzuoye" label="学生作业" prop="xueshengzuoye">
          <file-upload
          tip="点击上传学生作业"
          action="file/upload"
          :limit="1"
        ...
        <div v-else>
          <el-form-item v-if="ruleForm.xueshengzuoye" label="学生作业" prop="xueshengzuoye">
            <el-button type="text" size="small" @click="download($base.url+ruleForm.xueshengzuoye)">下载</el-button>
          </el-form-item>
        </div>    
      </el-col>      
      <el-col :span="12">
...
export default {
  ...
  methods: {
	...
	if(this.ruleForm.xueshengzuoye!=null) {
		this.ruleForm.xueshengzuoye = this.ruleForm.xueshengzuoye.replace(new RegExp(this.$base.url,"g"),"");
	}
