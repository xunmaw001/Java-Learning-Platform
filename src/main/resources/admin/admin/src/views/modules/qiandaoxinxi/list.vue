  ...
  <div class="main-content">
    ...
    <div v-if="showFlag">
      <el-form :inline="true" :model="searchForm" class="form-content">
		...
		<el-form-item class="select" label="签到类型" prop="qiandaoleixing">
		  <el-select  @change="qiandaoleixingChange" clearable v-model="searchForm.qiandaoleixing" placeholder="请选择签到类型">
		    <el-option
    ...
    getDataList() {
      ...
      let params = {
        ...
        sort: 'id',
          ...
          if(this.searchForm.qiandaoleixing!='' && this.searchForm.qiandaoleixing!=undefined){
