<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="select" v-if="type!='info'"  label="签到类型" prop="qiandaoleixing">
          <el-select :disabled="ro.qiandaoleixing" v-model="ruleForm.qiandaoleixing" placeholder="请选择签到类型">
            <el-option
        ...
        <div v-else>
          <el-form-item class="input" label="签到类型" prop="qiandaoleixing">
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="签到备注" prop="qiandaobeizhu">
          <el-input v-model="ruleForm.qiandaobeizhu" 
              placeholder="签到备注" clearable  :readonly="ro.qiandaobeizhu"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="签到备注" prop="qiandaobeizhu">
              <el-input v-model="ruleForm.qiandaobeizhu" 
                placeholder="签到备注" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
      ...
      this.$http({
		...
		if(json.xueshengxingming!=''&&json.xueshengxingming){
          ...
          this.$message.error(data.msg);
            ...
            this.qiandaoleixingOptions = "上课,下课".split(',')
    },
    // 多级联动参数
    info(id) {
      this.$http({
